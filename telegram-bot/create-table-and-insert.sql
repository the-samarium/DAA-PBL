-- Complete script to create harvesters table and insert sample data
-- Run this ENTIRE script in Supabase SQL Editor

-- Step 1: Create harvesters table if it doesn't exist
...
-- Step 3: Create policy for bot access (allows service role to read)
CREATE POLICY IF NOT EXISTS "harvesters_select_public" ON harvesters
FOR SELECT USING (true);

-- Step 2: Add sample equipment data
